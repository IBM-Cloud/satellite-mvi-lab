...
export MAS_CONFIG_DIR=/data/status/mas #Directory where generated config files will be saved (you may also provide pre-generated config files here)
export SLS_LICENSE_ID=<insert license id> #The license ID must match the license file available in SLS_LICENSE_FILE
export SLS_LICENSE_FILE=/data/status/downloads/license.dat #The path to the location of the license file.
